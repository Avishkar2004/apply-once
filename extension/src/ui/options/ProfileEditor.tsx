...
export function ProfileEditor({
  ...
  return (
    <div className="space-y-6">
      ...
      {drift.stale && (
        <Banner tone="warn">
          You last updated this {drift.daysSinceUpdate} days ago. Applications
          are filling from it as-is — worth a look before your next one.
        </Banner>
      )}
      ...
      {!completeness.ready && (
        <Banner tone="warn">
          Still missing:{" "}
          {completeness.missing.map((item) => item.label).join(", ")}. You can
          save now and finish later — applications will just skip those fields.
        </Banner>
      )}
      ...
      <Section title="Personal">
        <TextField
          ...
          onChange={(firstName) =>
            onChange({
              ...profile,
              personal: { ...profile.personal, firstName },
            })
          }
        />
        <TextField
          ...
          onChange={(lastName) =>
            onChange({
              ...profile,
              personal: { ...profile.personal, lastName },
            })
          }
        />
        <TextField
          ...
          onChange={(middleName) =>
            onChange({
              ...profile,
              personal: { ...profile.personal, middleName },
            })
          }
        />
        <TextField
          ...
          onChange={(preferredName) =>
            onChange({
              ...profile,
              personal: { ...profile.personal, preferredName },
            })
          }
        />
        <TextField
          ...
          onChange={(pronouns) =>
            onChange({
              ...profile,
              personal: { ...profile.personal, pronouns },
            })
          }
        />
        <TextField
          ...
          onChange={(dateOfBirth) =>
            onChange({
              ...profile,
              personal: { ...profile.personal, dateOfBirth },
            })
          }
        />
      </Section>
      ...
      <Section title="Contact">
        <TextField
          ...
          onChange={(email) =>
            onChange({ ...profile, contact: { ...profile.contact, email } })
          }
        />
        <TextField
          label="Phone"
          ...
          onChange={(phone) =>
            onChange({ ...profile, contact: { ...profile.contact, phone } })
          }
        />
        <TextField
          ...
          onChange={(phoneCountryCode) =>
            onChange({
              ...profile,
              contact: { ...profile.contact, phoneCountryCode },
            })
          }
        />
        <TextField
          ...
          onChange={(line1) =>
            onChange({
              ...
              contact: {
                ...profile.contact,
                address: { ...profile.contact.address, line1 },
              },
            })
          }
        />
        <TextField
          ...
          onChange={(line2) =>
            onChange({
              ...
              contact: {
                ...profile.contact,
                address: { ...profile.contact.address, line2 },
              },
            })
          }
        />
        <TextField
          ...
          onChange={(city) =>
            onChange({
              ...
              contact: {
                ...profile.contact,
                address: { ...profile.contact.address, city },
              },
            })
          }
        />
        <TextField
          ...
          onChange={(state) =>
            onChange({
              ...
              contact: {
                ...profile.contact,
                address: { ...profile.contact.address, state },
              },
            })
          }
        />
        <TextField
          ...
          onChange={(postalCode) =>
            onChange({
              ...
              contact: {
                ...profile.contact,
                address: { ...profile.contact.address, postalCode },
              },
            })
          }
        />
        <TextField
          ...
          onChange={(country) =>
            onChange({
              ...
              contact: {
                ...profile.contact,
                address: { ...profile.contact.address, country },
              },
            })
          }
        />
      ...
      <Section title="Links">
        <TextField
          ...
          onChange={(linkedin) =>
            onChange({ ...profile, links: { ...profile.links, linkedin } })
          }
        />
        <TextField
          label="GitHub"
          ...
          onChange={(github) =>
            onChange({ ...profile, links: { ...profile.links, github } })
          }
        />
        <TextField
          label="Portfolio"
          ...
          onChange={(portfolio) =>
            onChange({ ...profile, links: { ...profile.links, portfolio } })
          }
        />
        <TextField
          label="Website"
          ...
          onChange={(website) =>
            onChange({ ...profile, links: { ...profile.links, website } })
          }
        />
      </Section>
      ...
      <Section title="Work authorisation">
        ...
        <TextField
          ...
          onChange={(visaStatus) =>
            onChange({
              ...profile,
              workAuth: { ...profile.workAuth, visaStatus },
            })
          }
        />
        <CheckboxField
          ...
          onChange={(requiresSponsorship) =>
            onChange({
              ...profile,
              workAuth: { ...profile.workAuth, requiresSponsorship },
            })
          }
        />
      </Section>
      ...
      <Section title="Preferences">
        <TextField
          ...
          value={
            profile.preferences.desiredSalary
              ? String(profile.preferences.desiredSalary.amount)
              : ""
          }
          onChange={(value) => {
                ...
                desiredSalary:
                  Number.isFinite(amount) && value !== ""
                    ? {
                        amount,
                        currency:
                          profile.preferences.desiredSalary?.currency ?? "USD",
                        period:
                          profile.preferences.desiredSalary?.period ?? "year",
                      }
                    : undefined,
              },
            });
        ...
        <TextField
          ...
          type="number"
          value={
            profile.preferences.currentSalary
              ? String(profile.preferences.currentSalary.amount)
              : ""
          }
          onChange={(value) => {
            const amount = Number(value);
                ...
                currentSalary:
                  Number.isFinite(amount) && value !== ""
                    ? {
                        amount,
                        currency:
                          profile.preferences.currentSalary?.currency ?? "USD",
                      }
                    : undefined,
              },
            });
        ...
        <TextField
          ...
          onChange={(noticePeriod) =>
            onChange({
              ...profile,
              preferences: { ...profile.preferences, noticePeriod },
            })
          }
        />
        ...
        <TextField
          ...
          onChange={(earliestStartDate) =>
            onChange({
              ...profile,
              preferences: { ...profile.preferences, earliestStartDate },
            })
          }
        />
        <SelectField
          ...
          onChange={(remotePreference) =>
            onChange({
              ...profile,
              preferences: { ...profile.preferences, remotePreference },
            })
          }
        />
        <CheckboxField
          ...
          onChange={(willingToRelocate) =>
            onChange({
              ...profile,
              preferences: { ...profile.preferences, willingToRelocate },
            })
          }
        />
      </Section>
...
function EeoSection({
  ...
  return (
    ...
    >
      {(Object.keys(EEO_OPTIONS) as Array<keyof typeof EEO_OPTIONS>).map(
        (field) => (
          <SelectField
            key={field}
            label={label(field.replace(/([A-Z])/g, " $1"))}
            value={eeo[field]}
            options={EEO_OPTIONS[field].map((option) => ({
              value: option,
              label: label(option),
            }))}
...
function DocumentsSection({
  ...
  const bootstrapFromResume = async () => {
    ...
    setNote(undefined);
    try {
      const { profile: proposed, added } = await sendToBackground(
        "profile:from-resume",
        {
          resumeText,
        },
  ...
  return (
    <Section
      title="Documents"
      description="Stored encrypted on this device, attached at fill time."
    >
      {slots.map(({ slot, label }) => (
        <label key={slot}>
          ...
          <input
            ...
            accept={
              slot === "resume"
                ? ".pdf,.txt,.md,application/pdf,text/plain"
                : undefined
            }
      ...
      {/* Most boards ask for the letter in a textarea ("Cover Letter / Message"),
          where an uploaded PDF is no use at all. */}
      <div className="col-span-full">
        <TextArea
          label="Cover letter / message"
          hint="typed into “Cover Letter / Message” boxes. Keep it general — it goes to every employer as written."
          rows={6}
          value={str(profile.documents.coverLetterText)}
          onChange={(coverLetterText) =>
            onChange({
              ...profile,
              documents: { ...profile.documents, coverLetterText },
            })
          }
        />
      </div>
      ...
      {profile.documents.resume?.parsedText && (
        <div className="col-span-full">
          <Button
            variant="secondary"
            disabled={!!busy}
            onClick={() => void bootstrapFromResume()}
          >
            {busy ?? "Build my profile from this résumé"}
          </Button>
          <p className="mt-2 text-xs text-slate-500">
            Sends your résumé text to Anthropic with your own API key, and fills
            in only the fields you have left blank. Requires AI assistance to be
            set up.
          </p>
        </div>
      )}
      ...
      {busy && !profile.documents.resume?.parsedText && (
        <p className="col-span-full text-sm text-slate-500">{busy}</p>
      )}
      {note && (
        <div className="col-span-full">
